...
//        Page<Patient> patients1 = patientRepository.findByVaccinated(true, PageRequest.of(page, size));
//        model.addAttribute("patients1", patients1.getContent());
//        model.addAttribute("pages1", new int[patients1.getTotalPages()]);
//        model.addAttribute("currentPage1", page);
//        model.addAttribute("vaccinated", vaccinated);
        return "patients";
    }
    @GetMapping("/delete")
